{
  ...
  tree ->Draw("rms_EB:runNumber >> histo_EB(30, 315000, 325000, 200, 0, 20 )", "(energy_EB>=0) && (energy_EB/LaserCorrection_EB<1000) && rms_EB>=0 && rms_EB<=20");
  histo_EB->Draw("colz");
  ...
  tree ->Draw("rms_EE:runNumber >> histo_EE(30, 315000, 325000, 200, 0, 20 )", "(energy_EE>=0) && (energy_EB/LaserCorrection_EB<1000) && rms_EE>=0 && rms_EE<=20");
  histo_EE->Draw("colz");
