...
process = cms.Process('RECO',Run2_2018,pf_badHcalMitigation,premix_stage2)
...
list_inputFiles = open("../samples_timedep_raw.py","r")
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/tmp/amassiro/step3.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/tmp/amassiro/step3_inMINIAODSIM.root'),
...
process.DQMoutput = cms.OutputModule("DQMRootOutputModule",
    ...
    fileName = cms.untracked.string('file:/tmp/amassiro/step3_inDQM.root'),
